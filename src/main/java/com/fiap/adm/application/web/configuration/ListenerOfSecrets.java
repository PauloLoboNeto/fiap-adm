...
public class ListenerOfSecrets implements ApplicationListener<ApplicationPreparedEvent> {
    ...
    private final String MAIL_HOST = "spring.mail.host";
    private final String MAIL_PORT = "spring.mail.port";

    private final String MAIL_USERNAME = "spring.mail.username";

    private final String MAIL_PASSWORD = "spring.mail.password";
    ...
    public void onApplicationEvent(ApplicationPreparedEvent event) {
        ...
        String MAILHOST = getString(secretJson, "mailhost");
        String MAILPORT = getString(secretJson, "mailport");
        String MAILNAME = getString(secretJson, "mailname");
        String MAILPASS = getString(secretJson, "mailpass");
        ...
        props.put(MAIL_USERNAME, MAILNAME);
        props.put(MAIL_PASSWORD, MAILPASS);
